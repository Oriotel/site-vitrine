...
const founderData = {
  quote: "Les grands événements ne se produisent pas par hasard. Ils se construisent avec vision, précision et une équipe qui croit en l'excellence.",
  author: 'Alexandre Moreau',
  role: 'Fondateur & CEO, ORIOTEL',
  image: 'https://images.unsplash.com/photo-1540569014015-19a7ee504e3a?auto=format&fit=crop&q=80&w=1600', // Professional executive portrait
  bgText: 'ORIO TEL',
};

const QuoteEvent = () => {
  return (
    <section className="relative pt-20 pb-10 px-6 bg-transparent overflow-hidden font-sans">
      ...
      <div className="max-w-[1240px] mx-auto min-h-[500px]">
        <motion.div 
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="flex flex-col lg:flex-row rounded-[2rem] overflow-hidden shadow-2xl border border-white/5"
        >
          {/* Left Block: Message & Info */}
          <div 
            className="lg:w-[45%] p-10 lg:p-14 flex flex-col justify-center relative overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              <span className="inline-block text-[0.65rem] font-bold text-white/50 uppercase tracking-[0.3em] mb-6">
                FOUNDER'S MESSAGE
              </span>
              
              <div className="text-white/30 mb-6">
                <svg width="45" height="45" viewBox="0 0 120 100" fill="currentColor">
              ...
              <blockquote className="text-xl md:text-2xl font-light text-white leading-relaxed mb-10">
                "{founderData.quote}"
              </blockquote>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-bold text-white uppercase tracking-wider leading-none">
                    {founderData.author}
                  </span>
                  <span className="text-white/60 text-[0.65rem] mt-1.5 tracking-wide">
                    {founderData.role}
                  </span>
                </div>
              </div>
          ...
          <div className="lg:w-[55%] relative group min-h-[400px] lg:min-h-auto">
            {/* Main Founder Image */}
            <img 
              src={founderData.image} 
              alt={founderData.author}
