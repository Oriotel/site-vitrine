...
export function PremiumButton({ 
  ...
  const buttonClasses = cn(
    "group relative overflow-hidden rounded-full bg-signal-blue text-white transition-all hover:bg-signal-blue/90 hover:shadow-xl hover:shadow-signal-blue/20",
