  ...
  return (
    <section className="section-padding bg-white overflow-x-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="bg-white rounded-[3rem] p-2 lg:p-4 shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch min-h-[600px] lg:min-h-[650px]">
            
            {/* Informative Part: Elevated Sidebar (Perfectly Aligned) */}
            <div className="lg:col-span-4 flex flex-col h-full">
              <AnimatedSection
                className="flex flex-col justify-between h-full p-8 lg:p-12 bg-slate-50/50 rounded-[2.5rem] border border-white/50 shadow-inner"
              ...
              >
                <div className="flex flex-col gap-10">
                  ...
                  <div className="space-y-6">
                    <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 leading-tight font-carmine">
                       {t(left.title)}
                    </h2>
            ...
            <div className="lg:col-span-8 relative flex flex-col h-full overflow-hidden">
              <AnimatedSection animation="fade-in" delay={200} className="w-full h-full flex items-center">
