...
export function Hero() {
  ...
  return (
    <section className="relative w-full h-[100svh] lg:h-[100dvh] overflow-hidden bg-white font-sans flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col lg:items-start items-center justify-center px-6 md:px-12 lg:px-20 pt-4 md:pt-20 lg:text-left text-center overflow-y-auto sm:overflow-hidden">
        ...
        <div className="flex flex-col lg:items-start items-center gap-12 sm:gap-16 md:gap-20 w-full max-w-4xl py-0 md:py-4 shrink-0">
          ...
          {/* Tagline + description */}
          <div className="flex flex-col lg:items-start items-center gap-3 sm:gap-16 md:gap-8 shrink-0">
